...
class Entry(db.Model):
    ...
    # In track & field, an athlete's "mark" for a particular event is either the
    ...
    # a second, hundreths of a meter (a centimeter) and up to 1/4 inch.
...
class MeetDivisionEvent(db.Model):
    ...
    athletes = db.relationship(
            ...
            "Athlete", secondary="entries", back_populates="mdes")

    # heats = db.relationship("Heat", secondary="entries", back_populates="mde")
    # school = 
    # editor_users = db.relationship("User", secondary="schools")
...
#     id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    ...
    # entries = db.relationship("Entry", back_populates="heat", uselist=False)
    # athletes = db.relationship(
    #     "Athlete", secondary="entries", back_populates="heat")
    # mde = db.relationship(
    #     "MeetDivisionEvent", secondary="entries", back_populates="heats")
...
class EventDefinition(db.Model):
    ...
    mdes = db.relationship("MeetDivisionEvent", back_populates="event")
